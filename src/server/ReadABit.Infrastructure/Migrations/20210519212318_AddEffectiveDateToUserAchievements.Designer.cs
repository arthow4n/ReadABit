...
namespace ReadABit.Infrastructure.Migrations
{
    ...
    [Migration("20210519212318_AddEffectiveDateToUserAchievements")]
    partial class AddEffectiveDateToUserAchievements
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReadABit.Infrastructure.Models.ArticleReadingProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Conllu.TokenPointer>("ConlluTokenPointer")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("ArticleReadingProgress");
                });

            modelBuilder.Entity("ReadABit.Infrastructure.Models.UserAchievement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<LocalDate>("EffectiveDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("ReadABit.Infrastructure.Models.UserAchievementStreak", b =>
                {
                    b.Property<LocalDate>("LastEffectiveDateInStreak")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("ReadABit.Infrastructure.Models.UserPreference", b =>
                {
                    ...
                    b.Property<UserPreferenceData>("Data")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("ReadABit.Infrastructure.Models.WordFamiliarity", b =>
                {
                    ...
                    b.HasIndex("UserId", "CreatedAt", "Level");
            ...
            modelBuilder.Entity("ReadABit.Infrastructure.Models.ArticleReadingProgress", b =>
                {
                    b.HasOne("ReadABit.Infrastructure.Models.Article", "Article")
                        .WithMany("ArticleReadingProgress")
            ...
            modelBuilder.Entity("ReadABit.Infrastructure.Models.Article", b =>
                {
                    b.Navigation("ArticleReadingProgress");
                });
